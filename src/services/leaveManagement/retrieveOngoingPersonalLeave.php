<?php
    ...
    function retrieveOngoingPersonalLeave($eid)
    {
        $sql = "SELECT * from Leave_Application where Employee_ID=:eid and To_Date>=now()";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        try {
            ...
            if (isset($_GET['eid']) && $eid == null){
                $eid = $_GET['eid'];
            } else{
                $eid = $_SESSION['eid'];
            }
            
            $result = retrieveOngoingPersonalLeave($eid);
