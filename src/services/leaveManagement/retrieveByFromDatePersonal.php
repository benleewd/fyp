<?php
    ...
    function retrieveByFromDate($eid, $fromDate)
    {
        $sql = "SELECT * from Leave_Application where Employee_ID=:eid and From_Date=:fromDate";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        try {
            ...
            $result = retrieveByFromDate($eid, $fromDate);
