<?php
    ...
    function retrieveAllPresentLeave() {
        $sql = "SELECT * from Leave_Application inner join Emp_Basic_Information on leave_application.Employee_ID = Emp_Basic_Information.Employee_ID where To_Date<now()";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        try {
            $result = retrieveAllPresentLeave();
