<?php
    ...
    function retrieveByCurrentMonth($eid)
    {
        $sql = "SELECT * from Attendance where Employee_ID=:eid and Month(Date_Completed_Shift) = Month(current_date()) and Year(Date_Completed_Shift) = Year(current_date())";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        try {
            $eid = $_SESSION['eid'];
            $result = retrieveByCurrentMonth($eid);
