<?php
    ...
    {
        $sql = "INSERT INTO Emp_Address 
        (Employee_ID, Country, Block_No, Unit_No, Street_Name, Postal_Code, CREATED_BY) 
            VALUES (:eid, :country, :blockNo, :unitNo, :streetName, :postalCode, :createdBy)";
