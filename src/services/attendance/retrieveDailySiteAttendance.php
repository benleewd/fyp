<?php
    ...
    function retrieveDailySiteAttendance() {
        $sql = "SELECT * from Attendance where Date_Completed_Shift=CURDATE() and Clock_In IS NOT NULL";

        // $sql = "SELECT * from Attendance where Date_Completed_Shift<=CURDATE() and Clock_In IS NULL";
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        try {
            $result = retrieveDailySiteAttendance();
